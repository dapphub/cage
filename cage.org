...
#+BEGIN_SRC sol
  function shut(bytes32 ilk) public {
      ...
      require(art == 0);
      vat.tune(ilk, bytes32(msg.sender), bytes32(msg.sender), bytes32(msg.sender), -int(ink), 0);
  }
#+END_SRC
...
#+BEGIN_SRC sol
  function shop() public {
      ...
      vat.heal(bytes32(address(this)), bytes32(msg.sender), int(rad));
...
#+BEGIN_SRC sol
  function pack(bytes32 ilk) public {
      require(bags[ilk][bytes32(msg.sender)] == 0);
      bags[ilk][bytes32(msg.sender)] = add(bags[ilk][bytes32(msg.sender)], dai[msg.sender]);
  }
#+END_SRC
...
#+BEGIN_SRC sol
  function cash(bytes32 ilk) public {
      vat.flux(ilk, bytes32(address(this)), bytes32(msg.sender), int(rmul(bags[ilk][bytes32(msg.sender)], fixs[ilk])));
      bags[ilk][bytes32(msg.sender)]  = 0;
      dai[msg.sender]        = 0;
  }
#+END_SRC
